...
```{r r exploratory_plots_4, echo = FALSE, warning = FALSE, fig.cap = "Male Tail Length by Mating System"}
# Exploratory plot:
...
```{r r exploratory_plots_5, echo = FALSE, warning = FALSE, fig.cap = "Male Tail Length by Display System"}
# Exploratory plot:
...
```{r exploratory_plots_6, echo = FALSE, fig.cap = "Male Tail Length by Resource System"}
# Exploratory plot:
