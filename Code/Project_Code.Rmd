...
# SUPER uneven! Could be an issue for ANOVA because of likely uneven variances
count(birds.subset, vars = Display) # Also uneven but not as bad
...
``` {r q-1 plots, include = FALSE, fig.cap = "Female Mass vs Clutch Size"}
# Plot the results
...
```{r q-1 plot zoom, echo = FALSE, warning = FALSE, message = FALSE, fig.cap = "Female Tail Length vs Clutch Size"}
